...
- 爬 3 個網站的「一覽頁」和「店鋪詳細頁」： <br>
  - <a href="https://baito.mynavi.jp/tokyo/ss-1/ssm-1/sss-1/kd-61/" target="_blank">baito</a>
  - <a href="https://job-medley.com/ans/pref13/employment3/" target="_blank">medley</a>
  - <a href="https://relax-job.com/feature/employment/arbeit/" target="_blank">relax</a>
...
### 2. 安裝 Python
- 在 mac 或 windows
    - Python 官網<a href="https://www.python.org/downloads/macos/" target="_blank">下載安裝包</a>
...
- <a href="/pyenv安裝教學/" target="_blank">pyenv 安裝教學</a>
- 查看可以安裝的版本
> pyenv install -l
- 安裝其中一種 Python 的版本
